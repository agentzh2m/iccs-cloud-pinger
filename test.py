...
# print(subprocess.run(['ls', '-la'], stdout=subprocess.PIPE).stdout.decode('utf-8'))
# print(subprocess.run(['ssh', 'hssbss', 'ping', '-c', '10', 'www.google.com'], stdout=subprocess.PIPE).stdout.decode('utf-8'))
